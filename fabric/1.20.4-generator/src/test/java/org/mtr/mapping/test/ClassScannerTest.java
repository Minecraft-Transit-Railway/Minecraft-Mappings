...
public final class ClassScannerTest {
	...
	public void scan() {
		...
		scanner.put("ScoreboardScore", ScoreboardScore.class);
		scanner.put("ServerPlayerEntity", ServerPlayerEntity.class, "damageArmor", "damageHelmet", "damageShield", "getType");
		...
		scanner.put("VertexFormats", VertexFormats.class);
