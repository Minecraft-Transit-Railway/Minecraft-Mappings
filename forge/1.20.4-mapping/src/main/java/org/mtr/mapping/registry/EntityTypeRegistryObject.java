...
public final class EntityTypeRegistryObject<T extends EntityExtension> extends RegistryObject<EntityType<T>> {
	...
	private final net.minecraftforge.registries.RegistryObject<net.minecraft.world.entity.EntityType<T>> registryObject;

	EntityTypeRegistryObject(Identifier identifier) {
		registryObject = net.minecraftforge.registries.RegistryObject.create(identifier.data, ForgeRegistries.ENTITY_TYPES);
	}
