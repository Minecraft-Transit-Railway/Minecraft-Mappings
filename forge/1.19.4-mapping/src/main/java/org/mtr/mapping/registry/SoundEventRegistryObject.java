...
public final class SoundEventRegistryObject extends RegistryObject<SoundEvent> {
	...
	private final net.minecraftforge.registries.RegistryObject<net.minecraft.sounds.SoundEvent> registryObject;

	SoundEventRegistryObject(Identifier identifier) {
		registryObject = net.minecraftforge.registries.RegistryObject.create(identifier.data, ForgeRegistries.SOUND_EVENTS);
	}
