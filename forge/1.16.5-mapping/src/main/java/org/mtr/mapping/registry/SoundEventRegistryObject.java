...
public final class SoundEventRegistryObject extends RegistryObject<SoundEvent> {
	...
	private final net.minecraftforge.fml.RegistryObject<net.minecraft.util.SoundEvent> registryObject;

	SoundEventRegistryObject(Identifier identifier) {
		registryObject = net.minecraftforge.fml.RegistryObject.of(identifier.data, ForgeRegistries.SOUND_EVENTS);
	}
