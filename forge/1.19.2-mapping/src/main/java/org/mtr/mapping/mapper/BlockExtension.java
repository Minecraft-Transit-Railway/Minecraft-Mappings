...
public class BlockExtension extends BlockAbstractMapping implements BlockHelper {
	...
	@Deprecated
	@Override
	public final net.minecraft.world.item.ItemStack getCloneItemStack(net.minecraft.world.level.block.state.BlockState state, HitResult target, BlockGetter world, net.minecraft.core.BlockPos pos, Player player) {
