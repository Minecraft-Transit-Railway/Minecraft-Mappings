...
public final class GenerateHoldersTest {
	...
	public void generate() throws IOException {
		...
		generateHolders.put("ScoreboardCriterion", ScoreCriteria.class);
		generateHolders.put("ScoreboardCriterionRenderType", ScoreCriteria.RenderType.class);
		generateHolders.put("ScoreboardObjective", ScoreObjective.class);
		...
		generateHolders.put("Team", ScorePlayerTeam.class);
