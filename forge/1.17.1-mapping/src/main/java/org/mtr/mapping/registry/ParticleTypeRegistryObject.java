...
public final class ParticleTypeRegistryObject extends RegistryObject<DefaultParticleType> {
	...
	private final net.minecraftforge.fmllegacy.RegistryObject<SimpleParticleType> registryObject;

	ParticleTypeRegistryObject(Identifier identifier) {
		this.identifier = identifier;
		registryObject = net.minecraftforge.fmllegacy.RegistryObject.of(identifier.data, ForgeRegistries.PARTICLE_TYPES);
	}
